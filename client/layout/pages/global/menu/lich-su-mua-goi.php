<?php $options_header = ['title' => 'Lịch Sử Thuê Gói Thành Viên VIP']; ?>
...
<div class="border-muted-200 dark:border-muted-800 border-b py-6">
  <div class="flex flex-col items-center gap-3 text-center sm:flex-row sm:text-start">
    ...
    <i class="ri-vip-crown-2-line fs-20px"></i>
    </div>
    <div>
      <h2 class="nui-heading nui-heading-2xl nui-weight-medium nui-lead-normal text-muted-800 dark:text-white"> Lịch Sử Mua Gói</h2>
      <p class="nui-paragraph nui-paragraph-sm nui-weight-normal nui-lead-normal text-muted-500 dark:text-muted-400"> Hãy xem lại tất cả lịch sử mua gói mà bạn đã thanh toán trên nền tảng. </p>
    </div>
    <!-- <div class="divide-muted-200 dark:divide-muted-800 flex items-center divide-x sm:ms-auto">
      <div class="px-6 text-center sm:text-end">
        <p class="nui-paragraph nui-paragraph-sm nui-weight-normal nui-lead-normal text-muted-400 select-none"> Tổng Gói Đã Mua </p>
        <p class="nui-paragraph nui-paragraph-md nui-weight-normal nui-lead-normal text-muted-800 dark:text-muted-100 total-buyplan">0</p>
      </div>
    </div> -->
  </div>
</div>
  ...
  <div class="mt-2 overflow-x-auto ThanhDieu_dataTables_wrapper" id="ThanhDieu_DataTables_Table">
    <table class="w-full whitespace-nowrap">
      ...
      <tbody class="rl-history-plan"><tr class="odd"><td colspan="7" class="dataTables_empty text-muted-400 fs-13px text-center p-1">Đang tải lịch sử...</td></tr>
    </tbody>
    </table>
    <hr class="separator">
  </div>
