<?php $options_header = ['title' => 'Lịch Sử Thuê APP Bank Ảo']; ?>
...
<div class="border-muted-200 dark:border-muted-800 border-b py-6">
  <div class="flex flex-col items-center gap-3 text-center sm:flex-row sm:text-start">
    ...
    <div>
      <h2 class="nui-heading nui-heading-2xl nui-weight-medium nui-lead-normal text-muted-800 dark:text-white"> Lịch Sử Thuê APP</h2>
      <p class="nui-paragraph nui-paragraph-sm nui-weight-normal nui-lead-normal text-muted-500 dark:text-muted-400"> Dưới đây là tất cả lịch sử mà bạn đã thuê app bank ảo. </p>
    </div>
  </div>
</div>
