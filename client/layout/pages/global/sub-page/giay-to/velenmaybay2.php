<?php $options_header = ['title' => 'Tạo Fake Vé Lên Máy Bay Loại 3']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-fake-velenmaybay2 hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Fake Vé Lên Máy Bay Loại 3</p>
                                <span
                                    ...
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="ghichu"
                                                placeholder="Ví dụ: SKYPRIORITY" value="SKYPRIORITY" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="no"
                                                placeholder="Ví dụ: 999" value="999" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="9" for="khu">KHU</label>
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="khu"
                                                placeholder="Ví dụ: ZONE 1" value="ZONE 1" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="15" for="reg">REG</label>
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="reg"
                                                placeholder="Ví dụ: VN<?=WsRandomString::Number(10)?>" value="VN<?=WsRandomString::Number(10)?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div class="router-link-active router-link-exact-active group relative flex w-full flex-col overflow-hidden rounded-2xl kq-bill">
                        <?=$Bill->Demo('https://files.catbox.moe/9gll7n.png');?>
                    </div>
                </div>
            </div>
        </div>
