<?php $options_header = ['title' => 'Tạo Bill Fake VIB Bank Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-vibbank hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill VIB Bank</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="17" for="stkgui">4 Số Cuối Tài Khoản Người
                                        Chuyển</label>
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="stkgui"
                                                placeholder="Ví dụ: 10<?=WsRandomString::Number(4)?>"
                                                value="1234" required>
                                        </div>
                                    </div>
                                </div>
...
<option value="VIETCOMBANK" int="VCB" ant="VIETCOMBANK">VIETCOMBANK</option>
    <option value="VIETINBANK" int="CTG" ant="VIETINBANK">VIETINBANK</option>
    <option value="TECHCOMBANK" int="TCB" ant="TECHCOMBANK">TECHCOMBANK</option>
    <option value="BIDV" int="BIDV" ant="BIDV">BIDV</option>
    <option value="AGRIBANK" int="VARB" ant="AGRIBANK">AGRIBANK</option>
    <option value="NAVIBANK" int="NVB" ant="NAVIBANK">NAVIBANK</option>
    <option value="SACOMBANK" int="STB" ant="SACOMBANK">SACOMBANK</option>
    <option value="ACB" int="ACB" ant="ACB">ACB</option>
    <option value="MBBANK" int="MB" ant="MBBANK">MBBANK</option>
    <option value="TPBANK" int="TPB" ant="TPBANK">TPBANK</option>
    <option value="SHINHAN BANK" int="SVB" ant="SHINHAN BANK">SHINHAN BANK</option>
    <option value="VIB BANK" int="VIB" ant="VIB BANK">VIB BANK</option>
    <option value="VPBANK" int="VPB" ant="VPBANK">VPBANK</option>
    <option value="SHB" int="SHB" ant="SHB">SHB</option>
    <option value="EXIMBANK" int="EIB" ant="EXIMBANK">EXIMBANK</option>
  </select>
                                ...
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    ...
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="sogiaodich"
                                            value="<?=WsRandomString::Number(6)?>"
                                            placeholder="Ví dụ: <?=WsRandomString::Number(6)?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-1">
                            ...
                            <div class="col-span-1">
                                <div
                                    class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm nui-has-icon">
                                    <label class="nui-input-label" data-limit-text="25" for="thoigianhieuluc">Thời Gian
                                        Chuyển</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="thoigianhieuluc"
                                            value="<?=date('d/m/Y H:i')?>"
                                            placeholder="Ví dụ: <?=date('d/m/Y H:i')?>" required>
                                        <div class="nui-input-icon">
                                            <i class="ri-calendar-line"></i>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://files.catbox.moe/rfurv0.png');?>
                    </div>
                </div>
            </div>
        </div>
