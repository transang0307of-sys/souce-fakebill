<?php $options_header = ['title' => 'Tạo Bill Fake Worri Bank Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-worri hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Worri Bank</p>
                                <span
                                    ...
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="stknhan"
                                                placeholder="Ví dụ: 10<?=WsRandomString::Number(12)?>"
                                                value="10<?=WsRandomString::Number(12)?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="20" for="stkgui">Số Tài Khoản Người
                                        Gửi</label>
                                    <div class="nui-input-outer">
                                        <div>
                            ...
                            <div class="col-span-1">
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    ...
                                    <option data-bank="vietinbank" value="VIETINBANK (CTG)">Vietinbank</option>
                                    <option data-bank="vietcombank" value="VIETCOMBANK (VCB)">Vietcombank</option>
                                    <option data-bank="bidv" value="BIDV">BIDV</option>
                                    <option data-bank="agribank" value="AGRIBANK (VBA)">Agribank</option>
                                    <option data-bank="ocb" value="OCB">OCB</option>
                                    <option data-bank="mbbank" value="MBBANK (MB)">MBbank</option>
                                    <option data-bank="acbbank" value="ACB">ACB</option>
                                    <option data-bank="vpbank" value="VPBANK (VPB)">VPBank</option>
                                    <option data-bank="tpbank" value="TPBANK (TPB)">TPBank</option>
                                    <option data-bank="scb" value="SCB">Sacombank</option>
                                    <option data-bank="shb" value="SHB">SHB</option>
                                    <option data-bank="sgb" value="SGB">SaigonBank</option>
                                    <option data-bank="oceanbank" value="OJB">Oceanbank</option>
                                    <option data-bank="vietabank" value="VAB">VietABank</option>
                                    <option data-bank="namabank" value="NAB">NamABank</option>
                                    <option data-bank="vietbank" value="VB">VietBank</option>
                                    <option data-bank="dongabank" value="DAB">DongABank</option>
                                    </select>
                            ...
                            <div class="col-span-1">
                                <div
                                    ...
                                    <label class="nui-input-label" data-limit-text="25" for="time_bill">Chuyển Lúc</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="time_bill"
                            ...
                            <div class="col-span-1">
                                <label class="nui-label text-[0.825rem]" for="noidung" data-limit-text="60">Nội
                                    Dung Chuyển <span
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div class="router-link-active router-link-exact-active group relative flex w-full flex-col overflow-hidden rounded-2xl kq-bill">
                        <?=$Bill->Demo('https://files.catbox.moe/3afo6w.png');?>
                    </div>
                </div>
            </div>
        </div>
