<?php $options_header = ['title' => 'Tạo Bill Fake NCB Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-ncb hk-refresh-form space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-1 gap-3 nui-card nui-card-rounded-lg nui-card-default relative p-5 md:mx-0 shadow-lg border-none">
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3">
                                    <i class="ri-bank-fill me-1"></i> Tạo Bill NCB
                                </p>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    ...
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="stkgui" placeholder="Ví dụ: 10<?=WsRandomString::Number(9)?>" value="1223304323" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    ...
                                    <div class="nui-select-outer">  
                                        <select class="nui-select" name="bank_nhan" id="bank_nhan" required>
                                            <option value="TMCP CONG THHUONG VIET NAM" selected>Vietinbank (ICB)</option>
                                            <option value="NGOAI THUONG VIET NAM">Vietcombank (VCB)</option>
                                            <option value="TMCP KY THUONG VIET NAM">Techcombank (TCB)</option>
                                            <option value="TMCP DAU TU VA PHAT TRIEN">BIDV</option>
                                            <option value="NONG NGHIEP VA PT NONG THON">Agribank (VARB)</option>
                                            <option value="TMCP SAI GON THUONG TIN">Sacombank</option>
                                            <option value="TMCP A CHAU">ACB</option>
                                            <option value="TMCP QUAN DOI">MB BANK</option>
                                            <option value="TMCP TIEN PHONG">TP Bank</option>
                                            <option value="TMCP QUOC TE VIET NAM">VIB</option>
                                            <option value="TMCP VIET NAM THINH VUONG">VP Bank</option>
                                            <option value="TMCP SAI GON HA NOI">SHB</option>
                                            <option value="TMCP PHUONG DONG">OCB</option>
                                            <option value="TMCP NAM A">Nam Á Bank</option>
                                        </select>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm nui-has-icon">
                                    <label class="nui-input-label" data-limit-text="18" for="time_bill">Thời Gian Chuyển</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="time_bill" value="<?=date('H:i - m/d/Y')?>" placeholder="Ví dụ: <?=date('H:i - m/d/Y')?>" required>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div class="router-link-active router-link-exact-active group relative flex w-full flex-col overflow-hidden rounded-2xl kq-bill">
                        <?=$Bill->Demo('https://files.catbox.moe/mfprg4.png');?>
                    </div>
                </div>
            </div>
        </div>
