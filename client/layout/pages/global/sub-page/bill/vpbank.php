<?php $options_header = ['title' => 'Tạo Bill Fake VP Bank Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-vpbank hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill VP Bank</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="6" for="matrasoat">Mã Tra Soát</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="matrasoat"
                            ...
                            <div class="col-span-1">
                                <div
                                    ...
                                    <label class="nui-input-label" data-limit-text="10" for="thoigianchuyen">Thời Gian
                                        Chuyển</label>
                                    <div class="nui-input-outer">
