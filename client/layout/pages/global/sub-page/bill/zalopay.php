<?php $options_header = ['title' => 'Tạo Bill Fake Zalo Pay Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-zalopay hk-refresh-form space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-1 gap-3 nui-card nui-card-rounded-lg nui-card-default relative p-5 md:mx-0 shadow-lg border-none">
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Zalo Pay</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    ...
                                    <option data-bank="vietinbank" value="vietinbank">VietinBank (Công Thương)</option>
                                    <option data-bank="vietcombank" value="vietcombank">Vietcombank (Ngoại Thương)</option>
                                    <option data-bank="bidv" value="BIDV">BIDV (Kiến Thiết)</option>
                                    <option data-bank="techcombank" value="Techcombank">Techcombank (Kỹ Thương)</option>
                                    <option data-bank="agribank" value="Agribank">Agribank (Nông Thôn)</option>
                                    <option data-bank="ocb" value="OCB">OCB (Phương Đông)</option>
                                    <option data-bank="mbbank" value="MBBank">MBBank (Quân Đội)</option>
                                    <option data-bank="acbbank" value="ACB">ACB (Á Châu)</option>
                                    <option data-bank="vpbank" value="VPBank">VPBank (Việt Nam Thịnh Vượng)</option>
                                    <option data-bank="sacombank" value="sacombank">Sacombank (Sài Gòn Thương Tín)</option>
                                    <option data-bank="shb" value="SHB">SHB (Sài Gòn-Hà Nội)</option>
                                    <option data-bank="sgb" value="Saigonbank">SaigonBank (Sài Gòn Công Thương)</option>
                                    <option data-bank="oceanbank" value="Oceanbank">Oceanbank (Cổ Phần Đại Dương)</option>
                                    <option data-bank="vietabank" value="VietABank">VietABank (Cổ Phần Việt Á)</option>
                                    <option data-bank="namabank" value="NamABank">NamABank (Cổ Phần Nam Á)</option>
                                    <option data-bank="vietbank" value="VietBank">VietBank (Việt Nam Thương Tín)</option>
                                    <option data-bank="dongabank" value="DongABank">DongABank (cổ Phần Đông Á)</option>
                                    </select>
                                ...
                                <div
                                    ...
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="thoigianchuyen"
                                            value="<?=date('ymd-').WsRandomString::Number(9)?>"
                                            placeholder="Ví dụ: <?=date('ymd-').WsRandomString::Number(9)?>" required>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="10" for="phigiaodich">Phí Giao Dịch</label>
                                    <div class="nui-input-outer">
                            ...
                            <div class="col-span-1">
                                <label class="nui-label text-[0.825rem]" for="noidungchuyen" data-limit-text="45">Nội
                                    Dung Chuyển</label>
                                <div
                                    ...
                                    <div class="nui-textarea-outer">
                                        <textarea class="nui-textarea" name="noidungchuyen" rows="3"
                                            placeholder="Ví dụ: Nguyễn Văn A dùng Zalopay chuyển tiền"
                                            required>Nguyễn Văn A dùng Zalopay chuyển tiền</textarea>
                                    </div>
                                </div>
                            </div>
