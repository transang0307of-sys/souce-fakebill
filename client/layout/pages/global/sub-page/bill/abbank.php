<?php $options_header = ['title' => 'Tạo Bill Fake ABbank Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-abbank hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill ABbank</p>
                                <span
...
<div class="col-span-1">
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    ...
                                    <div class="nui-select-outer">
                                        ...
                                        <option value="CTG" selected>Vietinbank (CTG)</option>
                                            <option value="TCB">Techcombank (TCB)</option>
                                            <option value="VCB">Vietcombank (VCB)</option>
                                            <option value="ACB">ACB (Á Châu)</option>
                                            <option value="VARB">Agribank (VBA)</option>
                                            ...
                                            <option value="TPB">TP Bank (TPB)</option>
                                            <option value="VPB">VP Bank (VPB)</option>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="18" for="sogiaodich">Mã Giao
                                        Dịch</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="sogiaodich"
                                            value="AB<?=WsRandomString::Number(14)?>"
                                            placeholder="Ví dụ: AL<?=WsRandomString::Number(14)?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                <div
                                    ...
                                    <label class="nui-input-label" data-limit-text="30" for="thoigianchuyen">Thời Gian
                                        Chuyển</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="thoigianchuyen"
                                            value="<?= date('d/m/Y \l\ú\c H:i') ?>"
                                            placeholder="Ví dụ: <?= date('d/m/Y \l\ú\c H:i') ?>" required>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://files.catbox.moe/9a0o93.png');?>
                    </div>
                </div>
            </div>
        </div>
