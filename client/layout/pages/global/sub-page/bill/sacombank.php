<?php $options_header = ['title' => 'Tạo Bill Fake Sacombank Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-sacombank hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Sacombank</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="17" for="stk_nhan">Số Tài Khoản Người
                                        Nhận</label>
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="stk_nhan"
                                                placeholder="Ví dụ: 10<?=WsRandomString::Number(9)?>"
                            ...
                            <div class="col-span-1" id="bank_nhan">
                                <div
                                    ...
                                    <div class="nui-select-outer">
                                        <select name="bank_nhan" class="nui-select">
                                ...
                                <div
                                    ...
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="thoigianchuyen"
                                            ...
                                            placeholder="Ví dụ: <?=date('h:i:s d/m/Y')?>" required>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://files.catbox.moe/w0ladf.png');?>
                    </div>
                </div>
            </div>
        </div>
