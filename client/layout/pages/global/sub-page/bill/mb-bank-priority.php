<?php $options_header = ['title' => 'Tạo Bill Fake MB Bank Priority Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-mbbank-priority hk-refresh-form space-y-6">
                    <fieldset class="relative">
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none flex items-baseline">
                                    <i class="ri-bank-fill me-1"></i>
                                    Tạo Bill MB
                                    <span class="text-sm relative -top-1 ml-1.5 text-muted-500">&nbsp;|Priority</span>
                                </p>
                                <span
                                ...
                                <div
                                    ...
                                    <div class="nui-select-outer">
                                        <select class="nui-select" name="nganhangnhan">
                                            ...
                                            <option data-bank="vietcombank" value="vietcombank">Vietcombank (VCB)
                                            </option>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://thanhdieu.com/bill/mb-priority.jpg');?>
                    </div>
                </div>
            </div>
        </div>
