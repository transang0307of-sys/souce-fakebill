<?php $options_header = ['title' => 'Tạo Bill Fake Seabank Premium Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-seabank-premium hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Seabank Premium</p>
                                <span
                                    ...
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input" name="magiaodich"
                                                placeholder="Ví dụ: UL<?=WsRandomString::Number(6)?>"
                                                value="UL<?=WsRandomString::Number(6)?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="50" for="stkgui">Số Tài Khoản
                                        Chuyển</label>
                                    <div class="nui-input-outer">
                                        <div>
                                            <input type="text" class="nui-input td-format-text" name="stkgui"
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" data-limit-text="50" for="tennguoichuyen">Tên Người
                                        Chuyển</label>
                                    <div class="nui-input-outer">
                                        <div>
                            ...
                            <div class="col-span-1">
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    ...
                                    <div class="nui-select-outer">
                                        ...
                                        <option data-bank="vietinbank" value="CTG - TMCP Công Thương Việt Nam">Vietinbank - TMCP Công Thương Việt Nam</option>
                                        <option data-bank="vietcombank" value="VCB - TMCP Ngoại Thương Việt Nam">VCB - TMCP Ngoại Thương Việt Nam</option>
                                        <option data-bank="bidv" value="BIDV - Đầu tư và phát triển Việt Nam">BIDV - Ngân hàng Đầu tư và phát triển Việt Nam</option>
                                        <option data-bank="seabank" value="SEAB - TMCP Đông Nam Á">SeaBank - Ngân hàng TMCP Đông Nam Á</option>
                                        <option data-bank="techcombank" value="TCB - TMCP Kỹ Thương Việt Nam">Techcombank - Ngân hàng TMCP Kỹ Thương Việt Nam</option>
                                        <option data-bank="agribank" value="VARB - Nông Nghiệp Và PT Việt Nam">Agribank - Ngân hàng NN và PTNT Việt Nam</option>
                                        <option data-bank="ocb" value="OCB - TMCP Phương Đông">OCB - Ngân hàng TMCP Phương Đông</option>
                                        <option data-bank="mbbank" value="MB - TMCP Quân đội">MBBank - Ngân hàng TMCP Quân đội</option>
                                        <option data-bank="acbbank" value="ACB - TMCP Á Châu">ACB - Ngân hàng TMCP Á Châu</option>
                                        <option data-bank="vpbank" value="VPB - TMCP Việt Nam Thịnh Vượng">VPBank - Ngân hàng TMCP Việt Nam Thịnh Vượng</option>
                                        <option data-bank="tpbank" value="TPB - TMCP Tiên Phong">TPBank - Ngân hàng TMCP Tiên Phong</option>
                                        <option data-bank="sacombank" value="STB - TMCP Sài Gòn Thương Tín">Sacombank - Ngân hàng TMCP Sài Gòn Thương Tín</option>
                                        <option data-bank="shb" value="SHB - TMCP Sài Gòn Hà Nội">SHB - Ngân hàng TMCP Sài Gòn Hà Nội</option>
                                        <option data-bank="sgb" value="SGB - TMCP Sài Gòn Công Thương">SaigonBank - Ngân hàng TMCP Sài Gòn Công Thương</option>
                                        <option data-bank="oceanbank" value="OJB - Thương mại Đại Dương">Oceanbank - Ngân hàng Thương mại Đại Dương</option>
                                        <option data-bank="vietabank" value="VAB - TMCP Việt Á">VietABank - Ngân hàng TMCP Việt Á</option>
                                        <option data-bank="namabank" value="NAB - TMCP Nam Á">NamABank - Ngân hàng TMCP Nam Á</option>
                                        <option data-bank="dongabank" value="DAB - TMCP Đông Á">DongABank - Ngân hàng TMCP Đông Á</option>
                                        <option data-bank="vietbank" value="VB - TMCP Việt Nam Thương Tín">VietBank - Ngân hàng TMCP Việt Nam Thương Tín</option>
                                        <option data-bank="scb" value="SCB - TMCP Sài Gòn">SCB - Ngân hàng TMCP Sài Gòn</option>
                                        <option data-bank="vib" value="VIB - TMCP Quốc tế Việt Nam">VIB - Ngân hàng TMCP Quốc tế Việt Nam</option>
                                        <option data-bank="msb" value="MSB - TMCP Hàng Hải Việt Nam">MSB - Ngân hàng TMCP Hàng Hải Việt Nam</option>
                                        <option data-bank="lpb" value="LPB - TMCP Lộc Phát Việt Nam">LPB - Ngân hàng TMCP Lộc Phát Việt Nam</option>
                                        <option data-bank="abb" value="ABB - TMCP An Bình">ABBank - Ngân hàng TMCP An Bình</option>
                                        <option data-bank="ncb" value="NCB - TMCP Quốc Dân">NCB - Ngân hàng TMCP Quốc Dân</option>
                                        <option data-bank="pgb" value="PGB - TMCP Thịnh vượng Và Phát triển">PGB - Ngân Hàng TMCP Thịnh vượng và Phát triển</option>
                                        </select>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <div
                                        class="nui-input-number-wrapper nui-input-number-default nui-input-number-md nui-input-number-rounded-sm grow">
                                        <label class="nui-input-label" for="tongtien" data-limit-text="19">Tổng Tiền</label>
                                        <div class="nui-input-number-outer">
                                            <input type="text" class="nui-input-number td-format-money"
                                                data-td-msg="Số tiền chuyển phải là một con số!" name="tongtien"
                                                placeholder="Ví dụ: 100,000,000" value="100,000,000" required>
                                            <div class="nui-input-number-buttons">
                                                <button type="button" btn="destroy"><i
                                                        class="ri-close-line"></i></button>
                                ...
                                <div
                                    ...
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="thoigianchuyen"
                                            value="<?=date('j/n/Y');?>"
                                            placeholder="Ví dụ: <?=date('j/n/Y');?>" required>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div class="router-link-active router-link-exact-active group relative flex w-full flex-col overflow-hidden rounded-2xl kq-bill">
                        <?=$Bill->Demo('https://files.catbox.moe/fmdyzl.png');?>
                    </div>
                </div>
            </div>
        </div>
