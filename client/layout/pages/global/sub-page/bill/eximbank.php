<?php $options_header = ['title' => 'Tạo Bill Fake Eximbank Chuyển Khoản']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-eximbank hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Eximbank</p>
                                <span
...
<div class="col-span-1">
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    ...
                                    <div class="nui-select-outer">
                                        ...
                                        <option value="Vietinbank (CTG)" selected>Vietinbank (CTG)</option>
                                            <option value="Techcombank (TCB)">Techcombank (TCB)</option>
                                            <option value="Vietcombank (VCB)">Vietcombank (VCB)</option>
                                            <option value="ACB">ACB (Á Châu)</option>
                                            <option value="Agribank (VBA)">Agribank (VBA)</option>
                                            <option value="BIDV">BIDV (BIDV)</option>
                                            <option value="Sacombank (STB)">Sacombank (STB)</option>
                                            <option value="MB Bank (MB)">MB Bank (MB)</option>
                                            <option value="NAB">Nam Á Bank (Nam A Bank)</option>
                                            <option value="DAB">Đông Á Bank (DongA Bank)</option>
                                            <option value="OCB">OCB (Oricombank)</option>
                                            <option value="TPBank (TPB)">TP Bank (TPB)</option>
                                            <option value="VPBank (VPB)">VP Bank (VPB)</option>
                                            <option value="SGB">Saigonbank (SGB)</option>
                                            <option value="VIB">VIB (Ngân hàng Quốc Tế VIB)</option>
                                            <option value="SEAB">SeaBank (SeABank)</option>
                                        </select>
                                ...
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    ...
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="magiaodich"
                                            value="AB<?=WsRandomString::Number(5)?>"
                                            placeholder="Ví dụ: AB<?=WsRandomString::Number(5)?>" required>
                                    </div>
                                </div>
                            </div>
                             <div class="col-span-1">
                                <div
                                    ...
                                    <label class="nui-input-label" data-limit-text="16" for="ngaygiaodich">Ngày Giao Dịch</label>
                                    <div class="nui-input-outer">
                                        <input type="text" class="nui-input" name="ngaygiaodich"
                                            value="<?=date('d/m/Y')?>"
                                            placeholder="Ví dụ: <?=date('d/m/Y')?>" required>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://files.catbox.moe/d9cere.png');?>
                    </div>
                </div>
            </div>
        </div>
