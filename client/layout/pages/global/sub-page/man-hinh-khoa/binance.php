<?php $options_header = ['title' => 'Tạo Bill Fake Binance Biến Động Màn Hình Khoá']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-binance-man-hinh-khoa hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Binance Màn Hình Khoá</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <div
                                        ...
                                        <label class="nui-input-label" for="sotien" data-limit-text="30">Số USDT
                                            Nhận</label>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://i.ibb.co/rK52XPfq/2e62599b-7576-499d-a6f3-2ceec7b79438.png');?>
                    </div>
                </div>
            </div>
        </div>
