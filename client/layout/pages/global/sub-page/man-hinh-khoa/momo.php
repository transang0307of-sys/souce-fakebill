<?php $options_header = ['title' => 'Tạo Bill Fake Momo Biến Động Màn Hình Khoá']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-momo-man-hinh-khoa hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Momo Màn Hình Khoá</p>
                                <span
                            ...
                            <div class="col-span-1" id="nganhangchuyen">
                                <div
                                    class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md nui-has-icon">
                                    <label class="nui-select-label" for="nganhangchuyen">Chuyển tại </label>
                                    <div class="nui-select-outer">
                                        <select name="nganhangchuyen" class="nui-select">
<option value="VIETCOMBANK" int="VCB" ant="VIETCOMBANK">VIETCOMBANK</option>
    ...
    <option value="EXIMBANK" int="EIB" ant="EXIMBANK">EXIMBANK</option>
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <label class="nui-input-label" for="anhnen">Ảnh Nền Màn Hình Khoá <span class="text-danger-400">( Tránh ảnh nền tối và sẫm màu )</span>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://files.catbox.moe/ovod8t.png');?>
                    </div>
                </div>
            </div>
        </div>
