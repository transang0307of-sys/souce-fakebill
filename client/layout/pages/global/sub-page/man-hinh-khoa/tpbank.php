<?php $options_header = ['title' => 'Tạo Bill Fake TP Bank Biến Động Màn Hình Khoá']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-tpbank-man-hinh-khoa hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill TP Bank Màn Hình Khoá</p>
                                <span
                                ...
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md">
                                    ...
                                    <div class="nui-select-outer">
                                        <select class="nui-select" name="cachthuc">
                                            <option value="-" selected>Trừ Tiền</option>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div
                        ...
                        <?=$Bill->Demo('https://i.ibb.co/Xfw7Jb9X/848b902a-c0ba-4fb8-a357-e9be7690d537.png');?>
                    </div>
                </div>
            </div>
        </div>
