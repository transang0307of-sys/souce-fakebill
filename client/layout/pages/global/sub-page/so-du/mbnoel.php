<?php $options_header = ['title' => 'Tạo Bill Fake Số Dư MB Noel']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-sodu-mbnoel hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Số Dư MB Noel</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm">
                                    <div
                                        ...
                                        <label class="nui-input-label" for="sodu" data-limit-text="14">Số Dư Chính <span class="cursor-pointer" data-nui-tooltip-position="right" data-nui-tooltip="Đây là chỉ MB Noel nên đừng có fake lố quá."><i class="ri-question-line"></i></span></label>
