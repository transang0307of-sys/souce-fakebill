<?php $options_header = ['title' => 'Tạo Bill Fake Số Dư Techcombank']; ?>
    ...
    <div class="container">
        <div class="flex flex-col md:flex-row gap-4 pb-5">
            <div class="w-full md:w-3/4">
                <form class="hk-sodu-techcombank hk-refresh-form space-y-6">
                        ...
                        <div
                            ...
                            <legend class="mb-6-none">
                                <p class="nui-heading nui-heading-md nui-weight-bold nui-lead-none" tag="h3"><i
                                        class="ri-bank-fill me-1"></i> Tạo Bill Số Dư Techcombank</p>
                                <span
                            ...
                            <div class="col-span-1">
                                <div class="nui-select-wrapper nui-select-default nui-select-md nui-select-rounded-md">
                                    ...
                                    <div class="nui-select-outer">
                                        ...
                                        <option value="1" selected>(1) Tech - Mặc Định Đen</option>
                                            <option value="2">(2) Tech - Thành Phố Ban Đêm</option>
                                            <option value="3">(3) Tech - Bãi Biển</option>
                                            <option value="4">(4) Tech - Thành Phố Ban Ngày</option>
                                            <option value="5">(5) Tech - Mặc Định Đỏ</option>
                                            <option value="6">(6) Tech - Công Viên Mùa Xuân</option>
                                            <option value="7">(7) Tech - Cánh Đồng Xanh</option>
                                            <option value="8">(8) Tech - Khu Phố Nhà Ở</option>
                                            
                                            <option value="9">(9) Tech - Biển Hoàng Hôn</option>
                                            <option value="10">(10) Tech - Cảnh Biển Bình Minh</option>
                                            <option value="11">(11) Tech - Năng Động Thành Phố</option>
                                            <option value="12">(12) Tech - Cậu Bé Trượt Ván</option>
                                            <option value="13">(13) Tech - Vận Động Viên Đường Đua</option>
                                            <option value="14">(14) Tech - Xuân Vùng Cao</option>
                                            <option value="15">(15) Tech - Thành Phố Hiện Đại</option>
                                            <option value="16">(16) Tech - Cao Ốc Xanh</option>
                                            <option value="17">(17) Tech - Mùa Thu Phố</option>
            ...
            <div class="w-full card-demo-bill hidden md:block">
                <div class="col-span-6 sm:col-span-3">
                    <div class="router-link-active router-link-exact-active group relative flex w-full flex-col overflow-hidden rounded-2xl kq-bill">
                        <?=$Bill->Demo('https://files.catbox.moe/7cp7re.png');?>
                    </div>
                </div>
            </div>
        </div>
