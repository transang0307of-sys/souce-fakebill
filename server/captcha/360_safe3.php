...
function StopAttack($StrFiltKey,$StrFiltValue,$ArrFiltReq){  
	...
	if (preg_match("/".$ArrFiltReq."/is",$StrFiltValue)==1){   
			print "<div style=\"position:fixed;top:0px;width:100%;height:100%;background-color:white;color:green;font-weight:bold;border-bottom:5px solid #999;\"><br>�����ύ���в��Ϸ�����,лл����!<br><br>�˽��������:<a href=\"http://webscan.360.cn\">360��վ��ȫ���</a></div>";
			exit();
	}
