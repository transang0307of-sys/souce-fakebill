...
if (isset($_POST['action']) && $_POST['action'] === 'vietcombank') {
    ...
    $bdsd= $_POST["bdsd"];
    $phoiBank = $_SERVER['DOCUMENT_ROOT'].'/'.__IMG__.'/phoi/bill/'.($bdsd === 'macdinh' ? 'vcb.png' : 'vcb-bdsd.png');
    ...
    if (!file_exists($iconBankPath)) {
        ...
        $vndBox = imagettfbbox(($bdsd === 'macdinh' ? 28 : 29), 0, $fontPath.'vietcombank/SVN-Arial 3.ttf', $vnd);
        ...
        imagettftext($image, ($bdsd === 'macdinh' ? 28 : 29), 0, $xVND, $yVND, imagecolorallocate($image, 106, 148, 131), $fontPath.'vietcombank/SVN-Arial 3.ttf', $vnd);
        canchinhphai($image, 34, 1088, imagecolorallocate($image, 39, 39, 39), $fontPath.'vietcombank/UTM HelveBold.ttf', $tennguoinhan);
        canchinhphai($image, 33, 940, imagecolorallocate($image, 39,39,39), $fontPath.'vietcombank/UTM HelveBold.ttf', $stk);
        ...
        canchinhphai_banks($image, 1243, imagecolorallocate($image, 35, 35, 35), $fontPath.'vietcombank/UTM HelveBold.ttf', $iconBankPath, $nganhang_stk, $fullnamebank, 33, $fontPath.'vietcombank/SVN-Arial 3.ttf', imagecolorallocate($image, 48, 48, 48), 22, 39, 39, 72, 72);
        canchinhphai_noidung($image, 33, 1427, imagecolorallocate($image, 39, 39, 39), $fontPath.'vietcombank/UTM HelveBold.ttf', $noidungchuyen, 1.9);
        ...
        canchinhphai($image, 33, 1984, imagecolorallocate($image, 39,39,39), $fontPath.'vietcombank/UTM HelveBold.ttf', $magiaodich);
