...
if (isset($_POST['action']) && $_POST['action'] === 'bidv-premier') {
    ...
    $phoiBank = $_SERVER['DOCUMENT_ROOT'].'/'.__IMG__.'/phoi/bill/bidv-premier.png';
    ...
    canchinhgiua($image, 36, 710, imagecolorallocate($image, 0, 95, 78), $fontPath.'common/Mulish/Mulish-Bold.ttf', FormatNumber::TD($sotienchuyen, 2).' VND');
    canchinhgiua($image, 23, 815, imagecolorallocate($image, 117,117,117), $fontPath.'common/Mulish/Mulish-Bold.ttf', $sothamchieu, true);
    $BIDV = [
        ...
        ['text' => $stk, 'font' => $fontPath.'common/Mulish/Mulish-Bold.ttf', 'color' => imagecolorallocate($image, 0, 95, 78)],
        ['text' =>  '/', 'font' => $fontPath.'common/Mulish/Mulish-SemiBold.ttf', 'color' => imagecolorallocate($image, 61,68,87)],
        ['text' => $tennguoinhan, 'font' => $fontPath.'common/Mulish/Mulish-Bold.ttf', 'color' => imagecolorallocate($image, 0, 95, 78)],
        ['text' => '/', 'font' => $fontPath.'common/Mulish/Mulish-SemiBold.ttf', 'color' => imagecolorallocate($image, 61,68,87)],
        ['text' => $nganhangnhan, 'font' => $fontPath.'common/Mulish/Mulish-Bold.ttf', 'color' => imagecolorallocate($image, 0, 95, 78)],
    ...
    imagedestroy($image);
    $namebill = ['BIDV-Premier','Chuyển Khoản'];
